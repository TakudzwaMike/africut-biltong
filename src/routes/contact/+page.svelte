...
<script>
    ...
    export let form; // This prop receives data from the server action
</script>
...
<section id="contact" class="relative z-10">
	<div class="mx-auto max-w-6xl px-8 py-20 sm:py-24">
		<div class="rounded-xl bg-main p-8 sm:p-16">
            ...
            {#if form?.message}
            <div class="mx-auto mt-8 max-w-xl rounded-md p-4 text-center {form.success ? 'bg-accent text-main' : 'bg-red-500 text-white'}">
