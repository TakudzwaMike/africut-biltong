...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="rounded-lg border border-main/10 bg-white p-8 shadow-sm">
        ...
        >
            <div class="grid grid-cols-1 gap-6">
                ...
                <div class="grid grid-cols-2 gap-6">
                    ...
                    <div class="space-y-1">
                        ...
                        >
                        <!-- Simple select for now, could be robust list -->
                        <select
                            name="currency"
                            id="currency"
                            class="w-full rounded-md border-main/20 bg-light/50 px-3 py-2 text-sm focus:border-accent focus:ring-accent"
                    ...
                    <div class="space-y-1">
                        ...
                        <p class="text-xs text-main/40">
                            Used if no global markup applies.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <!-- Actions -->
            <div
                class="flex items-center justify-end gap-3 pt-4 border-t border-main/10"
            >
                <a
                    href="/_/admin/suppliers"
