...
<div class="relative z-10">
	<div class="mx-auto max-w-6xl px-8 py-20 sm:py-24">
		<div class="flex items-center justify-between">
			<div>
				<h1 class="text-4xl font-bold tracking-tight text-main sm:text-5xl">Solutions</h1>
				<p class="mt-4 text-lg leading-8 text-main/70">Manage your solutions pages.</p>
			</div>
			<a
