CREATE TYPE "public"."lead_status" AS ENUM('new', 'contacted', 'qualified', 'lost', 'closed');--> statement-breakpoint
...
CREATE TYPE "public"."user_role" AS ENUM('admin', 'customer', 'store_manager', 'content_editor');--> statement-breakpoint
...
ALTER TABLE "blog_post" ADD CONSTRAINT "blog_post_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "blog_posts_to_categories" ADD CONSTRAINT "blog_posts_to_categories_category_id_blog_category_id_fk" FOREIGN KEY ("category_id") REFERENCES "public"."blog_category"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "document" ADD CONSTRAINT "document_thumbnail_media_id_media_id_fk" FOREIGN KEY ("thumbnail_media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "gated_document_lead" ADD CONSTRAINT "gated_document_lead_document_id_document_id_fk" FOREIGN KEY ("document_id") REFERENCES "public"."document"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "lead" ADD CONSTRAINT "lead_solution_id_solution_id_fk" FOREIGN KEY ("solution_id") REFERENCES "public"."solution"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "order" ADD CONSTRAINT "order_shipping_address_id_user_address_id_fk" FOREIGN KEY ("shipping_address_id") REFERENCES "public"."user_address"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "page_content" ADD CONSTRAINT "page_content_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "solutions_to_products" ADD CONSTRAINT "solutions_to_products_product_id_product_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."product"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "team_member" ADD CONSTRAINT "team_member_media_id_media_id_fk" FOREIGN KEY ("media_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "tracked_link" ADD CONSTRAINT "tracked_link_user_id_user_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
